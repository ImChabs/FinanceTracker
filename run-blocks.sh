...
write_block_manifest() {
  ...
  printf '  "timestamp_utc": "%s",\n' "$timestamp_utc" >>"$block_manifest_file"
  printf '  "detected_reasoning_effort": "%s",\n' "$detected_reasoning_effort" >>"$block_manifest_file"
  printf '  "codex_config_override_requested": "%s",\n' "$reasoning_config_override" >>"$block_manifest_file"
  printf '  "result": "%s",\n' "$result" >>"$block_manifest_file"
  printf '  "exit_code": %s,\n' "$exit_code" >>"$block_manifest_file"
  printf '  "jsonl_log_path": "%s",\n' "$log_file" >>"$block_manifest_file"
  printf '  "last_message_path": "%s"\n' "$last_message_file" >>"$block_manifest_file"
  printf '}\n' >>"$block_manifest_file"
}
