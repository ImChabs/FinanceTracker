Next block name
BLOCK 36 - Automation Harness Run Manifest Index
...
- Preserve the new per-block summary artifact format and keep any run-level manifest similarly simple and machine-readable
